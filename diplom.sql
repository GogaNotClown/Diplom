...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 26 2022 г., 21:07
...
CREATE TABLE `scores` (
  `offset_card_number` int NOT NULL,
  `score_on_the_exam` int NOT NULL,
  `score_on_the_defense_of_the_diplom` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `scores` (`offset_card_number`, `score_on_the_exam`, `score_on_the_defense_of_the_diplom`) VALUES
(1, 5, 4),
(2, 3, 5),
(3, 3, 3),
(4, 5, 5),
...
CREATE TABLE `students` (
  ...
  `offset_card_number` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `Faculty` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
(5, 'Царева', 'Алиса', 'Романова', '1759', 'Гелологический', '37'),
(6, 'Лапина', 'Алиса', 'Кирилловна', '2800', 'Химический', '13'),
(7, 'Соколов', 'Вячеслав', 'Русланович', '3000', 'Гелологический', '37'),
(8, 'Карасев', 'Александр', 'Владимирович', '3750', 'Искусство', '10'),
...
(13, 'Шаруда', 'Дмитрий', 'Степанович', '3502', 'Билологический', '25'),
...
(17, 'Смирнов', 'Дмитрий', 'Александрович', '1016', 'Искусство', '10'),
...
CREATE TABLE `teachers` (
  ...
  `Patronymic` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Extent` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Rank` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `topic_list` (
  `tl_id` int NOT NULL,
  `tl_title` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `scores`
  ADD PRIMARY KEY (`offset_card_number`);
...
--
ALTER TABLE `diploms`
  MODIFY `diplom_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT для таблицы `students`
--
ALTER TABLE `students`
  MODIFY `student_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT для таблицы `teachers`
--
ALTER TABLE `teachers`
  MODIFY `teacher_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT для таблицы `topic_list`
--
ALTER TABLE `topic_list`
  MODIFY `tl_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `scores`
  ADD CONSTRAINT `scores_ibfk_1` FOREIGN KEY (`offset_card_number`) REFERENCES `students` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
