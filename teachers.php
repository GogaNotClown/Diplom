...
$result = $connect -> query($select_teachers) -> fetch_all(MYSQLI_ASSOC);
...
foreach ($result as $row) {
    ...
    echo "<p class='extent'><span>Степень: </span> " . $row['Extent'] . "<br></p>";
    echo "<p class='rank'><span>Звание: </span> " . $row['Rank'] . "<br></p>";
    echo "<p class='rank'><span>Кафедра: </span> " . $row['Department'] . "<br></p>";
    echo "<p class='telephone'><span>Номер телефона: </span> " . $row['Telephone'] . "<br></p>";
    echo "<p class='email'><span>Почта: </span> " . $row['Email'] . "<br></p>";
    echo "</div>";
    echo "<div class='buttons'>";
    echo "<button class='ban'>Уволить</button>";
    echo "</div>";
    echo "</div>";
}
echo "</div>";
